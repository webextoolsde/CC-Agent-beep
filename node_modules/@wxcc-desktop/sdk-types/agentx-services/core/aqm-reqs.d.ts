...
export declare class AqmReqs {
    ...
    private bindCheck;
    /**
     * Handles type-dependent field matching using __typeMap
     * @param typeMap The type map configuration
     * @param msg The message to check
     * @returns True if the message matches the type-dependent conditions, false otherwise
     */
    private handleTypeMapBindCheck;
    /**
     * Handles regular binding checks for all fields
     * @param bind The binding pattern to check against
     * @param msg The message to check
     * @returns True if the message matches the binding pattern, false otherwise
     */
    private handleRegularBindCheck;
