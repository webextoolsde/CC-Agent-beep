...
export declare const WEBEX_CALLING: {
    ...
    GET_SECONDARY_PREFERRED_ANSWER_ENDPOINTS_FAILED: string;
    SET_PREFERRED_PRIMARY_ANSWER_ENDPOINT_FAILED: string;
    SET_PREFERRED_SECONDARY_ANSWER_ENDPOINT_FAILED: string;
