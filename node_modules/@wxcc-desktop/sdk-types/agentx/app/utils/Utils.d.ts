...
export declare const handleIMIMessageEvent: (agentId: string, orgId: string, conversationId: string) => void;
...
export declare const handleInitialChannelStateMapUpdate: (idleCodeName: string, lastStateChangeTimestamp: number, auxCodeId: string) => void;
