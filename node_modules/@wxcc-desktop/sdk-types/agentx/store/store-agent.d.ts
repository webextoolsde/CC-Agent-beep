...
export declare class ModuleAgent extends UserStore {
    ...
    lcmUrl: string;
    teamUniqueId: string;
    dialPlan: import("@/../../agentx-services/dist/types/services/aqm/types/aqm-service-configs.types").DialPlan;
    outDialEp: string;
    ...
    callDevices: Record<string, string>;
    secondaryExtensionLineOwnerIds: Record<string, string>;
    constructor();
    ...
    get lineOwnerIdForCurrentExtension(): string | undefined;
    ...
    get getChannelTypes(): Service.Aqm.Configs.Channels[];
    ...
    updateCallDevices(devices: Record<string, string>): void;
    updateSecondaryExtensionLineOwnerIds(secondaryExtensionLineOwnerIds: Record<string, string>): void;
    ...
    updateIsAgentLoggedIn(isLoggedIn: boolean): void;
}
